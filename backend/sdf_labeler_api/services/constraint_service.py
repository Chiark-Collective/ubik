...
class ConstraintService:
    ...
    def add_from_dict(self, project_id: str, constraint_data: dict) -> Constraint:
        """Add a constraint from a dictionary representation.

        Parses the dict as a Constraint model and adds it to the project.
        Useful for adding constraints generated by auto-analysis.
        """
        from pydantic import TypeAdapter

        # Parse the constraint dict into the proper discriminated union type
        adapter = TypeAdapter(Constraint)
        constraint = adapter.validate_python(constraint_data)
        return self.add(project_id, constraint)
