...
describe("labelStore", () => {
  ...
  describe("undo/redo", () => {
    it("should undo add operation", () => {
      ...
      useLabelStore.getState().addConstraint(projectId, constraint);
      expect(useLabelStore.getState().getConstraints(projectId)).toHaveLength(
        1,
      );
  ...
  describe("getConstraints", () => {
    it("should return empty array for unknown project", () => {
      const constraints = useLabelStore
        .getState()
        .getConstraints("unknown-project");
    ...
    it("should isolate constraints by project", () => {
      ...
      expect(useLabelStore.getState().getConstraints(project1)[0].id).toBe(
        "box-1",
      );
      expect(useLabelStore.getState().getConstraints(project2)[0].id).toBe(
        "box-2",
      );
    });
  });
  ...
  describe("setConstraints", () => {
    it("should bulk set constraints for a project", () => {
      ...
      expect(useLabelStore.getState().getConstraints(projectId)[0].id).toBe(
        "box-1",
      );
      expect(useLabelStore.getState().getConstraints(projectId)[1].id).toBe(
        "box-2",
      );
    });
